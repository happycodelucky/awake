...
| 2026-03-08 | Generated SwiftUI code without modernization pass | Code uses older patterns instead of current best practices | Use swiftui-pro skill to review and modernize SwiftUI to latest APIs |
| 2026-03-08 | Worked around Xcode preview limitations with SPM workarounds instead of using Xcode directly | Added unnecessary complexity; previews should have been used natively | Eventually switch to Xcode for full SwiftUI preview support |
| 2026-03-08 | Build scripts on command line produce older visual appearance than Xcode builds | Undiagnosed root cause; bundled app looks outdated compared to expected modern UI | Investigate build script vs. Xcode build differences; may be signing, asset handling, or framework version issue |
